...
We will now need to run 4 chi-square tests. We will run each test with the assumption that there is no relationship between gun ownership and the other variable in question: race, sex, political view, oppinion on capitol punishment and belief in god. 
