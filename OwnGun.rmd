...
We will be using the folloiwng methods: two way tables, bar charts and a chi-squared test. We will use these to analyze the following factor variables: whether or not someone owns a gun, a person's race, sex, political views, opinion on capitol punishment and beilef in god.
...
##### Gun ownership vs. Opinion on Capitol Punishment
```{r}
...
##### Gun ownership vs. Belief in god
```{r}
